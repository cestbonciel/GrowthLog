## 이스트캠프 프론티어 2기 iOS 앱 개발자 부트캠프 - 첫번째 미니프로젝트,  3조
### GrowthLog 
...
|<a href="https://github.com/cestbonciel/" target="_blank">김서현</a> | <a href="https://github.com/cestbonciel/GrowthLog" target="_blank">백현진</a> | <a href="https://github.com/cestbonciel/GrowthLog" target="_blank">이주용</a>|
|:---:|:---:|:---:|
...
|`iOS`|`iOS`|`iOS`|
|`역할`: 리더, 프로젝트 일정 관리|`역할`: 팀원, 회의록 작성|`역할`: 팀원, 발표자|
